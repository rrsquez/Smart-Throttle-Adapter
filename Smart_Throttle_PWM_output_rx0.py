# File: Smart_Throttle_PWM_output_rx0.py
# By: Richard R. Vasquez
# Date: 10/19/2024
#
# Note: This version is almost perfected. Still needs improvements. PWM output only.
# Analog output doesn't work with m = 1 and b = 0. Must determine why.
...
# Predefine constants
STOPPED = 12153          # Throttle min. voltage = 0.588V
MINPWM = 3277            # PWM set to 5%
MAXPWM = 6554            # PWM set to 10%
